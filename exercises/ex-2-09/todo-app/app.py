...
# update row in postgres based on row id in table todotable
# postgres_cursor.execute("UPDATE todotable SET title = (%s), description = (%s) WHERE id =  ", (title,))



# postgres_cursor.execute("UPDATE todotablde SET title = (%s), description = (%s) WHERE id = ", (title,))
